 ...
 */
final class Version20190421183820 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post ADD author_id INT NOT NULL, ADD slug VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post DROP author_id, DROP slug');
    }
}
